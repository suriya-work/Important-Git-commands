➡️ git init: Initializes a new Git repository. This is the first command to start a new project in a GitHub repository. It creates a hidden .git subdirectory in your project directory
